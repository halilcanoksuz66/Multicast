...
Q_CONSTINIT const QMetaObject NetworkManager::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14NetworkManagerE_t,
        ...
        // method 'networkStarted'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'networkStopped'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'networkError'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (NetworkManager::*)(const QByteArray & , const QString & );
            if (_q_method_type _q_method = &NetworkManager::dataReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_q_method_type _q_method = &NetworkManager::networkStarted; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (NetworkManager::*)();
            if (_q_method_type _q_method = &NetworkManager::networkStopped; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (_q_method_type _q_method = &NetworkManager::networkError; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
